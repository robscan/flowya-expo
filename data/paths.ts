/**
 * Modelo de Datos - Paths
 * Scope 1.2: Tipo Path según definición de producto
 * 
...
export interface PathMetadata {
  inferredFrom?: string[]; // IDs de spots que generaron este path
  suggestedAt?: Date;
  acceptedAt?: Date;
  editedAt?: Date;
  usageCount?: number;
...
/**
 * Helper para obtener los objetos Spot completos de un Path
 */
export function getPathSpots(path: Path, allSpots: Spot[]): Spot[] {
  return path.spots
